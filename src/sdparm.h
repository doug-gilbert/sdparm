...
struct sdparm_mode_descriptor_t {
    int num_descriptors_off;
    int num_descriptors_len;
    int descriptor_len;         /* -1 for unknown */
    int descriptor_len_off;     /* active when previous unknown */
    int first_descriptor_off;
    const char * name;
};
